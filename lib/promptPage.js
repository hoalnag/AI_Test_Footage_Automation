...
export function writePromptPage({ slug, caption, prompt, vimeoId, uploadedAt, galleryUrl }) {
  const backHref = galleryUrl || "../index.html";
...
<body>
  <a class="back" href="${escapeHtml(backHref)}">&larr; Back to gallery</a>
